...
const NAV_ITEMS = [
  ...
  { path: "/forensics", label: "Coin Forensics", icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" },
  { path: "/wallet", label: "Wallet Dive", icon: "M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" },
...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white flex">
      {/* Sidebar */}
      <aside className={`${sidebarOpen ? "w-64" : "w-16"} bg-gray-900 border-r border-gray-800 transition-all duration-200 flex flex-col`}>
        <div className="p-4 border-b border-gray-800">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-emerald-500 rounded-lg flex items-center justify-center font-bold text-sm">MI</div>
            {sidebarOpen && (
              <div>
                <h1 className="font-bold text-sm">Memecoin Intel</h1>
                <p className="text-xs text-gray-500">Insider Tracker</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="p-3 border-t border-gray-800">
          <button
            ...
            className="w-full flex items-center justify-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-gray-800 transition-colors"
          >
